  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-lg-6 order-1 order-lg-2" data-aos="fade-left">
       <img class="rounded float-left" style="height:420px; width:210px" src="<?php echo base_url(); ?>asset/img/sijago.jpg" alt="">
       <img class="rounded float-right" style="height:420px; width:210px" src="<?php echo base_url(); ?>asset/img/sijago2.jpg" alt="">
     </div>
