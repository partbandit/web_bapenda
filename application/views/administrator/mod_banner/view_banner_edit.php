<?php 
    echo "<h6 class='mb-0 text-uppercase' style='color:white;'>Edit Banner Link</h6>
                  <hr/>
                  <div class='card'>
                    <div class='card-body'>
          ...
          echo "<div class='col-md-12'>
                  ...
                  <tbody>
                    ...
                    <tr><th width='120px' scope='row'>Ganti Gambar</th>    <td><input type='file' class='form-control' name='c'>";
                                                                               if ($rows['gambar'] != ''){ echo "<i style='color:red'>Lihat Gambar Saat ini : </i><a target='_BLANK' href='".base_url()."asset/banner/$rows[gambar]'>$rows[gambar]</a>"; } echo "</td></tr>
                  </tbody>
                  </table>
                </div>
